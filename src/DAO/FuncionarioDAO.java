...
public class FuncionarioDAO extends ExecuteSQL{
    ...
    public boolean Testar_Funcionario(int codigo){
    ...
    public List<Funcionario> CapturarFuncionario(int codigo){
        String sql = "select * from funcionario where id_funcionario = "+ codigo + "";
        List<Funcionario> lista = new ArrayList<>();
    ...
    public List<Funcionario> ListarFuncionario(){
        String sql = "select id_funcionario, nome, login from funcionario";
        List<Funcionario> lista = new ArrayList<>();
        try {
            PreparedStatement ps = getCon().prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
