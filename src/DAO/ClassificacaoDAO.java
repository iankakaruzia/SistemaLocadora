...
public class ClassificacaoDAO extends ExecuteSQL{
    ...
    public boolean Testar_Classificacao(int codigo){
        boolean resultado = false;
        
        try {
            String sql = "select * from classificacao where id_classificacao = " + codigo + "";
            PreparedStatement ps = getCon().prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
    ...
    public List<Classificacao> CapturarClassificacao(int codigo){
        String sql = "select * from classificacao where id_classificacao = " + codigo + "";
        List<Classificacao> lista = new ArrayList<>();
    ...
    public String Alterar_Classificacao(Classificacao a){
        String sql = "update classificacao set nome = ?, preco = ? where id_classificacao = ?";
    ...
    public List<Classificacao> ListarClassificacao(){
        String sql = "select id_classificacao, nome, preco from classificacao";
        List<Classificacao> lista = new ArrayList<>();
        try {
            PreparedStatement ps = getCon().prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
